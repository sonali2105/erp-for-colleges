      ...
      <div class="row" >
        <div class="col" >
          <div class="card shadow">
			...
			<h4 >Old Password&nbsp;&nbsp;&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;<input class="form-control form-control-alternative" type="password" id="old_password" name="old_password" style="width:25%;display:inline"></input></h4>
			<h4 >New Password&nbsp;&nbsp;&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;<input type="password" class="form-control form-control-alternative" id="new_password"style="width:25%;display:inline" name="new_password"></input></h4>
			<h4 >Confirm Password&nbsp;&nbsp;&nbsp;<input type="password" id="confirm_password"class="form-control form-control-alternative" style="width:25%;display:inline" name="confirm_password"></input></h4><br><button  class="btn btn-sm btn-primary" >change</button></div></form>
			</div>
            </div>
