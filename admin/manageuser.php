	...
	<div class="header bg-gradient-primary pb-8 pt-5 pt-md-8" >
      <div class="container-fluid">
        <div class="header-body"></div></div></div>
		  ...
		  <div class="row" >
            <a href="newregistrationstudent.html"><div class="col-xl-3 col-lg-6" >
              <div class="card card-stats mb-4 mb-xl-0" style="border:2px solid lightblue">
                <div class="card-body" >
                  <div class="row">
                    <div class="col" >
                      <h5 class="card-title text-uppercase text-muted mb-0" style="padding-top:7%"><b>Student</b></h5>
